        ...
        <div className='w-full h-[364px] pr-4 overflow-y-scroll overflow-x-hidden'>
          ...
          <form className='mt-4 md:mt-6 lg:mt-8' onSubmit={(event) => {event.preventDefault();alert('Email sent!')}} method='POST'>
            <div className='flex flex-col gap-y-4 md:gap-y-5 lg:gap-y-6'>
              ...
              <div>
                <label htmlFor='business-name' className='block text-xs md:text-sm lg:text-base text-rehsok-gray'>
              ...
              <div>
                <label htmlFor='contact-name' className='block text-xs md:text-sm lg:text-base text-rehsok-gray'>
                  Nombre de contacto
                </label>
                <input
                  type='text'
